...
<head>
    ...
    <title>Area Utente - Viaggi</title>
...
<body class="bg-light">
    ...
    <main class="container py-4">
        <header class="dashboard-header text-center">
            ...
            <p class="welcome-message">Esplora le nostre offerte e gestisci le tue prenotazioni</p>
        </header>
        ...
        <div class="dashboard-actions">
            <div class="action-card">
                ...
                <h3>Prenotazioni</h3>
                <p class="text-muted">Visualizza e gestisci le tue prenotazioni attive</p>
                <a href="visualizza_prenotazioni_ut.php" class="btn btn-primary mt-2">Vai alle prenotazioni</a>
            </div>

            <div class="action-card">
                <i class="fas fa-credit-card"></i>
                <h3>Pagamenti</h3>
                <p class="text-muted">Controlla lo stato dei tuoi pagamenti</p>
                <a href="visualizza_pagamenti_ut.php" class="btn btn-primary mt-2">Vai ai pagamenti</a>
            </div>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4" id="destinazioniContainer">
            ...
            $sql = "SELECT viaggi.Codice_viaggio, 
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $row['id'] = $row['Codice_viaggio'];
                    $row['img'] = (strpos($row['immagine'], 'img/') === 0) ? $row['immagine'] : 'img/' . $row['immagine'];
    ...
    <footer class="bg-dark text-center py-3">
        <div class="container">
            <p class="mb-0">&copy; 2025 Viaggi - Tutti i diritti riservati</p>
        </div>
    </footer>
